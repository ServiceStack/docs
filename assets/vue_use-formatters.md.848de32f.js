...
</code></pre></div><p>That can also be used to decorate properties in C# DTOs with the <a href="/locode/formatters">Format Attribute</a>.</p>`,5),f=a(`<p>Use <code>setFormatters</code> to register new formatters that you want to call with <code>[Format(&quot;method&quot;)]</code> or to override the built-in formatting functions by registering alternative implementations for:</p><div class="language-ts"><pre><code><span class="token function">setFormatters</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
