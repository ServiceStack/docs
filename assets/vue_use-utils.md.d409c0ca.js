...
<span class="token keyword">const</span> <span class="token punctuation">{</span>
    ...
    parseHtml<span class="token punctuation">,</span>        <span class="token comment">// Parse HTML fragment into tagName, innerHTML and attrs segments</span>
...
</code></pre></div>`,3),d=e(`<p>TypeScript definition of the API surface area and type information for correct usage of <code>useUtils()</code></p><div class="language-ts"><pre><code><span class="token comment">/** Format Date into required input[type=date] format */</span>
...
<span class="token comment">/** Parse HTML fragment into tagName, innerHTML and attrs segments */</span>
<span class="token keyword">declare</span> <span class="token keyword">function</span> <span class="token function">parseHtml</span><span class="token punctuation">(</span>html<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">)</span><span class="token operator">:</span> ParsedHtml <span class="token operator">|</span> <span class="token keyword">null</span><span class="token punctuation">;</span>
