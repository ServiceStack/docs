import{_ as t,C as e,o,c as p,d as a,b as n,e as c,q as l,a as r}from"../app.5c693fe4.js";const m={},u=a("h2",{id:"formatters",class:"mt-8 mb-4 text-2xl font-semibold text-gray-900 dark:text-gray-100"}," Using Formatters ",-1),i=r(`<div class="language-js"><pre><code><span class="token keyword">import</span> <span class="token punctuation">{</span> useFormatters <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;@servicestack/vue&#39;</span>
...
</code></pre></div>`,3);function k(d,f,g,v,F,h){const s=e("TextLink");return o(),p("div",null,[u,a("p",null,[n("Your App and custom templates can also utilize @servicestack/vue's "),c(s,{href:"/vue/use-formatters"},{default:l(()=>[n("built-in formatting functions")]),_:1}),n(" from:")]),i])}var b=t(m,[["render",k]]);export{b as F};
