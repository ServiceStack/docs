...
</code></pre></div><p>See the <a href="/vue/gallery/formats">PreviewFormat</a> for examples for what each of these format functions render to.</p>`,6),m=t(`<p>Global default formats can be customized with <code>setDefaultFormats</code>:</p><div class="language-js"><pre><code><span class="token function">setDefaultFormats</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
...
</code></pre></div><p>That can also be used to decorate properties in C# DTOs with the <a href="/locode/formatters">Format Attribute</a>.</p>`,5),f=t(`<p>TypeScript definition of the API surface area and type information for correct usage of <code>useFormatters()</code></p><div class="language-ts"><pre><code><span class="token keyword">class</span> <span class="token class-name">Formats</span> <span class="token punctuation">{</span>
...
</code></pre></div>`,2),v='{"title":"Formatting Functions andMethods","description":"","frontmatter":{"title":"Formatting Functions andMethods"},"headers":[],"relativePath":"vue/use-formatters.md"}',b={},T=Object.assign(b,{__name:"use-formatters",setup(g){return(y,F)=>{const o=e("Breadcrumb"),c=e("Breadcrumbs");return l(),r("div",null,[i,n(c,{class:"not-prose my-4 mb-8","home-href":"/vue/"},{default:s(()=>[n(o,{href:"/vue/gallery/"},{default:s(()=>[a("gallery")]),_:1}),n(o,null,{default:s(()=>[a("useFormatters")]),_:1})]),_:1}),k,n(p,{component:"setDefaultFormats"},{default:s(()=>[a("Set global default formats")]),_:1}),m,n(p,{component:"setFormatters"},{default:s(()=>[a("Register custom formatters")]),_:1}),d,n(p,{component:"TypeScript Definition"}),f])}}});export{v as __pageData,T as default};
