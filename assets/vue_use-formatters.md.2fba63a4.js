...
</code></pre></div><p>That can also be used to decorate properties in C# DTOs with the <a href="/locode/formatters">Format Attribute</a>.</p>`,5),f=a(`<p>Using <code>setFormatters</code> also allows you to override the default formatting functions used by providing alternative implementations for:</p><div class="language-ts"><pre><code><span class="token function">setFormatters</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
